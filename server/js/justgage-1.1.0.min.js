...
JustGage.prototype.generateShadow = function (svg, defs) {
	...
	var rid = Math.floor(Math.random() * 1e16);
	
	// FILTER
	gaussFilter = document.createElementNS(svg, "filter");
	gaussFilter.setAttribute("id", "inner-shadow-" + rid);
	...
	if (!obj.config.hideInnerShadow) {	
		obj.canvas.canvas.childNodes[2].setAttribute("filter", "url(#inner-shadow-" + rid + ")");
		obj.canvas.canvas.childNodes[3].setAttribute("filter", "url(#inner-shadow-" + rid + ")");
	}
